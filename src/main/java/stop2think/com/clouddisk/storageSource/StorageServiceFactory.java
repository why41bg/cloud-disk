...
public class StorageServiceFactory {
    ...
    private static final Map<String, StorageService> SIMPLE_STORAGE_SERVICE_MAP = new HashMap<>();

    public static StorageService getSimpleStorageService(String storageSource) {
